...
use Royalcms\Component\Smarty\UndefinedVariable;
...
class Data
{
     ...
     * @var string
     */
    public $template_class = '\Royalcms\Component\Smarty\Internal\Template';
    /**
     * template variables
     *
     * @var array
    ...
    public function assign($tpl_var, $value = null, $nocache = false)
    {
        if (is_array($tpl_var)) {
            foreach ($tpl_var as $_key => $_val) {
                if ($_key != '') {
                    $this->tpl_vars[$_key] = new Variable($_val, $nocache);
                }
            }
        } else {
            if ($tpl_var != '') {
                ...
                if ($_key != '') {
                    if (!isset($this->tpl_vars[$_key])) {
                        ...
                        if ($tpl_var_inst instanceof UndefinedVariable) {
                            $this->tpl_vars[$_key] = new Variable(null, $nocache);
                        } else {
    ...
    public function appendByRef($tpl_var, &$value, $merge = false)
    {
        if ($tpl_var != '' && isset($value)) {
            if (!isset($this->tpl_vars[$tpl_var])) {
                $this->tpl_vars[$tpl_var] = new Variable();
            }
    ...
    {
        // load Config class
        $config = new Config($config_file, $this->smarty, $this);
