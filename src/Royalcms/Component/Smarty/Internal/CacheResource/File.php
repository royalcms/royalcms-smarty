<?php namespace Royalcms\Component\Smarty\Internal\CacheResource;
...
class File extends CacheResource
{
     ...
     */
    public function writeCachedContent(Template $_template, $content)
    {
        if (File::writeFile($_template->cached->filepath, $content, $_template->smarty) === true) {
