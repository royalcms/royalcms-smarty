...
use Royalcms\Component\Smarty\Internal\Config\File\Compiler;
...
class Config
{
    ...
    public function compileConfigSource()
    {
        ...
        if (!is_object($this->compiler_object)) {
            // load compiler
            $this->compiler_object = new Compiler($this->smarty);
        }
        // compile locking
        ...
        File::writeFile($this->getCompiledFilepath(), $this->getCompiledConfig(), $this->smarty);
    }
    ...
    public function __get($property_name)
    {
        switch ($property_name) {
            case 'source':
                ...
                $this->source = Resource::config($this);
